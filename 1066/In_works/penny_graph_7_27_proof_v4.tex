...
\title{A Proof Package for the Bound\\ $\boldsymbol{g(n)\ge \lceil 7n/27\rceil}$}
...
\]
The proof specializes Swanepoel's broken-lattice input to $m=7$, isolates the unique possible equality break, proves the required boundary-side orientation, and eliminates every remaining local configuration by explicit independent-set certificates.
\end{abstract}
...
\section{The $t_4t_5$-present branch before full flatness}
