...
We use the following published facts from Swanepoel's proof of the lower bound for planar contact graphs \cite[pp.~649--670]{Swanepoel2002}. The boundary-arc structure is Theorem~4 on p.~661; the two-extra-neighbour statement is Lemma~8 on pp.~659--660; the triple obstruction and the cap used below come from Lemma~9 and its proof on pp.~660--661; and the Euclidean all-but-one equality and break inequality are Lemma~10 and inequality~(5) on pp.~661--665.
