...
def closedPlacement_of_generatedClosure
  ...
  (explicitTransitionClosedPlacementCertificate_of_generatedClosure
    O hk base orientation closure H).toClosedPlacement
...
def closedPlacement_of_generatedClosure_reduced
    ...
    (H :
      GeneratedSeparationInterface.GeneratedReducedMetricHypotheses
        O hk base orientation) :
    DeformedPlacement.ClosedPlacement k hk :=
  (explicitTransitionClosedPlacementCertificate_of_generatedClosure_reduced
    O hk base orientation closure H).toClosedPlacement
...
theorem targetUpperConstructionFiveSixteenAt_exactBlock_of_generatedClosure
  ...
  exact
    targetUpperConstructionFiveSixteenAt_exactBlock_of_generated_closed_chain
      ...
      H.separated H.same_block_isometry
